                        ...
                        [
                            dbc.CardBody(
                                [
                                    ...
                                    html.H2(
                                        f"${compliance_report['summary_metrics']['total_transaction_volume']:,.2f}",
                        ...
                        [
                            dbc.CardBody(
                                [
                                    ...
                                    html.H2(
                                        f"${compliance_report['summary_metrics']['sanctioned_volume']:,.2f}",
                        ...
                        [
                            dbc.CardBody(
                                [
                                    ...
                                    html.H2(
                                        f"{compliance_report['summary_metrics']['percent_sanctioned']:.2f}%",
                        ...
                        [
                            dbc.CardBody(
                                [
                                    ...
                                    html.H2(
                                        f"${compliance_report['summary_metrics']['potential_penalty_exposure']:,.2f}",
                                        className="card-text text-center text-danger",
                                    ),
                                ]
                            )
