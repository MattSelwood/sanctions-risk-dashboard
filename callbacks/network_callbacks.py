...
def register_network_callbacks(app, network_analysis, scored_data):
    ...
    @app.callback(
        ...
        Input("tabs", "active_tab")  # This is just a dummy input to trigger the callback
    )
    def generate_network_graph(active_tab):
        ...
        for node in G.nodes():
            ...
            node_sizes.append(np.log1p(country_volume) * 2)  # Log scale for better visualization
